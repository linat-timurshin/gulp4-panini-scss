...
```
* в папке **partial** можно создавать подпапки для отдельных страниц, на подключение это не влияет  
...
Пример: создали паршел **logo.html:** в **partial/all-page/** подключили в нужном месте(в данном примере в хедере):
```html
<header>
